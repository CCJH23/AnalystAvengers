...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mssql+pyodbc://analystavengers:Admin12345678@analystavengersdb.database.windows.net:1433/AnalystAvenger_SQL?driver=ODBC+Driver+18+for+SQL+Server'
db = SQLAlchemy(app)
